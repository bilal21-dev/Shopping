...
const About = () => {
  ...
  return (
    <div className='h-screen flex justify-center items-center'>
      ...
      <div style={animation}>
        <p className='bg-white bg-opacity-60 px-5 py-7 rounded-xl text-xl ml-7 mr-7'>At [Company Name], our mission is to [clearly state the company's purpose]. We believe in [core values] and are committed to making a positive impact on [target audience]. Our team of experts works tirelessly to develop innovative solutions that [briefly describe the company's products/services]. Join us in our quest to [company's vision].</p>
      </div>
    </div>
  )
}
